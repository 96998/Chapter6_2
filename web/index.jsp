...
<TABLE WIDTH=770 HEIGHT=109 BORDER=0 align="center" CELLPADDING=0 CELLSPACING=0>
    <TR>
        ...
        <TD width="621" HEIGHT=103 ROWSPAN=1>
...
<TABLE cellSpacing=0 cellPadding=0 width=770 align=center border=0>
    <TBODY>
    <TR>
        <TD><a href="http://www.itzcn.com/"><IMG height=38 src=images/menu_1x1.gif width=74 border=0 alt="网站首页"></a><a
                href="http://bbs.itzcn.com"><IMG height=38 src=images/menu_1x2.gif width=78 border=0 alt="技术论坛"></a><IMG
                height=38 src=images/menu_1x4.gif width=77 border=0 alt="联系方式"><IMG height=38 src=images/menu_1x6.gif
                                                                                    width=77 border=0 alt="商业注册"><a
                href="#"><IMG height=38 src=images/menu_1x7.gif width=77 border=0 alt="建设中"></a><IMG height=38
                                                                                                     src=images/menu_1x9.gif
                                                                                                     width=77 border=0
                                                                                                     alt="意见反馈"><IMG
                height=38 src=images/menu_1x5.gif width=77 border=0 alt="联系方式"><IMG height=38 src=images/menu_1x11.gif
...
<table width="769" border="0" align="center" cellpadding="0" cellspacing="0" height="477">
    <tr>
        ...
        <td width="192" height="34" style="border-right: 1 solid #C0C0C0"><a name="lianx"><img border="0"
                                                                                               src="images/title1.gif"
                                                                                               width="192" height="34"></a>
        </td>
        <td valign="top" height="423" width="572" rowspan="4">
                            ...
                            <TABLE cellSpacing=0 cellPadding=0 width="511" border=0>
                                ...
                                <TR>
                                    <TD width="165" rowSpan=6>
                                        <DIV align=left><img border="0" src="images/cp.jpg" width="127" height="165">
                                        </DIV>
                                    </TD>
                                ...
                                <TR>
                                    ...
                                    <TD height=22 width="266"><textarea rows="5" cols="30" name="address"></textarea>
                                    </TD>
                                </TR>
                                <tr>
    ...
    <tr>
        <td width="192" height="144" style="border-right: 1 solid #C0C0C0"><span lang="zh-cn"><font color="#242424"
                                                                                                    face="宋体"
                                                                                                    size="2"><img
                border="0" src="images/jt1.gif" width="11" height="11"></font></span>窗内网一群：33925615 <br>
            <br>
            <span lang="zh-cn"><font color="#242424" face="宋体" size="2"><img border="0" src="images/jt1.gif" width="11"
                                                                             height="11"></font></span>窗内网二群：45368980
            <br>
            <br>
            <span lang="zh-cn"><font color="#242424" face="宋体" size="2"><img border="0" src="images/jt1.gif" width="11"
                                                                             height="11"></font></span>窗内网三群：107423140<br>
            <br>
            <span lang="zh-cn"><font color="#242424" face="宋体" size="2"><img border="0" src="images/jt1.gif" width="11"
                                                                             height="11"></font></span><a
                    href="mailto:mydear1021@yahoo.com.cn?subject=我要购买商业版">窗内网四群：184726020</a></td>
    </tr>
    <tr>
        <td width="192" height="33" style="border-right: 1 solid #C0C0C0">&nbsp;</td>
    </tr>
    <tr>
        <td width="192" height="212" style="border-right: 1 solid #C0C0C0"><span lang="zh-cn"><b><font color="#242424"
                                                                                                       size="2"
                                                                                                       face="宋体">
    ...
    <tr>
        <td height="37" colspan="4" bgcolor="#c0c0c0" background="images/bar_bg2.gif"
            style="border-left: 1 solid #C0C0C0; border-right: 1 solid #C0C0C0; border-top: 1 solid #C0C0C0"
            width="770">
            <table cellPadding="0" cellSpacing="1" class="d9pt" height="20"
                   style="PADDING-BOTTOM: 1px; PADDING-LEFT: 4px; PADDING-RIGHT: 4px; PADDING-TOP: 1px" width="750">
                <tbody>
                <tr>
    ...
    <tr>
        <td height="18" colspan="4" bgcolor="#c0c0c0" width="770"><img border="0" src="images/topindex3.gif" width="770"
                                                                       height="16"></td>
    </tr>
</table>
</body>
